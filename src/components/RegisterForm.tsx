...
function RegisterForm({previousStep}:PropType) {
  ...
  return (
    ...
    {/* Divider */}
    <div className='flex items-center gap-2 text-gray-400 text-sm mt-6 w-full max-w-sm'>
        <span className='flex-1 h-px bg-gray-200'></span>
        OR
        <span className='flex-1 h-px bg-gray-200'></span>
    </div>

    {/* 🔥 Google Button (Only Change Here) */}
    <button 
        type="button"
        className='w-full max-w-sm mt-4 flex items-center justify-center gap-3 border border-gray-300 hover:bg-gray-50 py-3 rounded-xl text-gray-700 font-medium transition-all duration-200'
