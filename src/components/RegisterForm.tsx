...
function RegisterForm({previousStep}:PropType) {
  ...
  return (
    ...
    className='flex flex-col gap-5 w-full max-w-sm'>
        ...
        <input type="text" placeholder='Enter Your Email' className='w-full border border-gray-300 rounded-xl py-3 pl-10 pr-4 text-gray-800 focus:ring-2 focus:ring-green-500 focus:outline-none'
